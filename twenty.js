...
const generateTest = async () => {
  ...
  for (i = 0; i < data.length; i++) {
    ...
    if ((data[i].transaction_date.slice(-4)) === '2020') {
...
setTimeout(() => {
  ...
  let twentytextprep = ""
  for (trade of twenty_twenty) {
    twentytextprep += '<blockquote> Senator: ' + trade.senator + ' <br> Transaction Date: ' + trade.transaction_date + '<br> Amount: ' + trade.amount + '<br> Asset Type: ' + trade.asset_type + '<br> Ticker: ' + trade.ticker + '<br> Owner: ' + trade.owner + '</blockquote>';
    //console.log(test);
  }

  twentytext.innerHTML = twentytextprep;
...
//   console.log(imgsrc)
//   figure.innerHTML = '<figure class="image is-square"> <img src="'+imgsrc+'" alt="Placeholder image" /> </figure>'
// }
